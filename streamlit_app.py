        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Do not include any pleasantries. I would only like the output. I need you to be very clear on the formatting, especially in the financial information section. Please ensure that all of the information provided looks the same. Please include a formatted. "
                    "Include a header section called 'Background Information' section - with the title in bold - that provides a comprehensive overview from the LP memo, "
                    "the property, and the deal. Ensure that the 'Property Overview' section is presented in bullet points - this should be extracted from the LP memo, similar to the 'Investment Summary' section. - this should be extratced from the LP memo "
                    "This is extremely important. For the 'Updated Financial Information' section, use proper formatting in line with the formatting used above (ie bold header), spacing, and bullet points. I want it to include the following and please ensure that all text is clean and normal print: 'Previous net worth: {number from the oldest personal financial statement} on one line, then another line with 'Current net worth: {number from the newest personal financial statement}, then on another line: 'Change in assets between the personal financial statements: {include the difference in assets}"
                    "Only return the required output. Also, please ensure that the numbers included, especially for the financial section, are consistent with normal text. This should include consistent formatting with previous and updated net worth figures. All bullet points must also be formatted as standard"
                ),
            }
        ]
