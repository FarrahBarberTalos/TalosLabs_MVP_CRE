        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "I need you to not include any pleasantries, and I just want the output. The format that I would like it in is with four headers. I want a header on background information, which is a comprehensive summary of the uploaded LP memo. I want a property information section, which is a bullet pointed overview of all of the relevant property information within the LP memo. I want a section on Investment summary, which is a bullet pointed overview of all of the relevant investment information within the LP memo. I want an Updated Financial Information section, which is a bullet pointed list that overs the previous net worth of the client, which can be found in the oldest personal financial statement, and the updated net worth, which is based on the information in the newest personal financial statement. There should then be a summary sentence in this section that covers the total asset changes"
                ),
            }
        ]
